...
class WelcomeSignupCustomerPage extends StatefulWidget { // Updated class name
  const WelcomeSignupCustomerPage({Key? key}) : super(key: key);

  @override
  State<WelcomeSignupCustomerPage> createState() => _WelcomeSignupCustomerPageState(); // Updated state class name
}

class _WelcomeSignupCustomerPageState extends State<WelcomeSignupCustomerPage> with TickerProviderStateMixin {
