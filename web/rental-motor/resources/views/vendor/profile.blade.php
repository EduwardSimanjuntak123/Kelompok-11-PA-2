        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="bg-blue-600 text-white rounded-t-xl px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-2xl font-bold">Edit Profil Vendor</h2>
                        <p class="text-sm text-blue-100 mt-1">Perbarui informasi profil dan toko</p>
                    </div>
                ...
                <form action="{{ route('vendor.profile.edit') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="{{ $user['name'] }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300">
                            </div>
                            <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="shop_description" rows="3"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300">{{ $vendor['shop_description'] ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-md transition duration-300 flex items-center">
