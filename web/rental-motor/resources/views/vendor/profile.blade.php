...
@section('content')
    <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md" x-data="profileData()">
        ...
        <h1 class="text-3xl font-semibold mb-6 text-gray-800">Profil Vendor</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-lg"><strong>Nama Toko:</strong> <span x-text="user.vendor.ShopName"></span></p>
                <p class="text-lg"><strong>Alamat Toko:</strong> <span x-text="user.vendor.ShopAddress"></span></p>
                <p class="text-lg"><strong>Deskripsi Toko:</strong> <span x-text="user.vendor.ShopDescription"></span></p>
            </div>
            <div class="flex items-center justify-center">
                <img :src="'user.profile_image' ? 'user.profile_image' : 'https://via.placeholder.com/150'" 
                     alt="Foto Profil" class="w-32 h-32 rounded-full object-cover border">
            </div>
        </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <form @submit.prevent="updateProfile()">
                    ...
                    <label class="block mb-2">Email:
                        <input type="email" value="{{ $vendorData['user']['email'] ?? '' }}"
    ...
    <script>
        function profileData() {
            return {
                ...
                updateProfile() {
                    fetch('http://localhost:8080/vendor/profile/edit', {
                            method: 'PUT',
                            headers: {
