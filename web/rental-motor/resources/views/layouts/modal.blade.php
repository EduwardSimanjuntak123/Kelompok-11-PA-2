        ...
        <form id="addMotorForm" method="POST" action="{{ route('motor.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="addMotorName" name="name" type="text" class="w-full border p-2 rounded" required
                        autofocus>
                    <label class="block text-gray-700 mt-2">Brand</label>
                    <input id="addMotorBrand" name="brand" type="text" class="w-full border p-2 rounded" required>
                    <label class="block text-gray-700 mt-2">Model</label>
                    <input id="addMotorModel" name="model" type="text" class="w-full border p-2 rounded" required>
                ...
                <div>
                    ...
                    <input id="addMotorColor" name="color" type="text" class="w-full border p-2 rounded" required>
                    ...
                    <select id="addMotorStatus" name="status" class="w-full border p-2 rounded" required>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
        ...
        <form id="editMotorForm" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-gray-700">Warna</label>
                    <input id="editMotorColor" name="color" type="text" class="w-full border p-2 rounded" required>
                    <label class="block text-gray-700 mt-2">Harga</label>
