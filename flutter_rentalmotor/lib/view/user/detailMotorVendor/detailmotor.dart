...
import 'package:flutter_rentalmotor/view/user/booking_motor/sewamotor.dart';
      ...
      child: Wrap(
        ...
        children: [
          ...
          _buildInfoBox(
              ...
              Colors.orange),
          _buildInfoBox(
            Icons.two_wheeler, // Ikon motor dua roda
            motor != null
                ? (motor!["platmotor"]?.toString() ?? "Tidak Diketahui")
                : "Tidak Diketahui",
            "Plat motor",
            Colors.black,
          )
