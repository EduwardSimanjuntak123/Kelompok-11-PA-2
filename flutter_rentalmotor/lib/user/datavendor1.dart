...
class DataVendor1 extends StatefulWidget {
  @override
  _DataVendor1State createState() => _DataVendor1State();
}

class _DataVendor1State extends State<DataVendor1> {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5),
                          Text('Laguboti, Toba Samosir', style: TextStyle(color: Colors.grey)),
                        ],
                      ),
                      Container(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => DetailMotorPage1()),
          );
        },
      ),
    );
